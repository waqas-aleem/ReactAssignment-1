...
<div  className=" container-fluid bigburderarea">
  <div className="row">
    ...
    <div class="col-md-8 col-sm-12 col-lg-4 text-center"  >
      ...
      <img src={Shape2} alt="" className="ourchefshape2 " style={{transform: "scaleX(-1)", marginTop:"0px"}}/>
  ...
  <div className="row">
    <div className="col-md-6 ">
      ...
      <p className="bigburgerp">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus lacinia odio vitae vestibulum vestibulum. </p>
      <button className="orderbtn"> Order Now </button>
  </div>
    </div>
    <div className="col-md-6">
  ...
  <div className="row">
    <div className="col-md-4 col-lg-4 text-center">
      <img src={Shape1} className="ourchefshape1 mb-5" alt="" style={{transform: "scaleX(-1)"}}/>
    </div>


    <div className="col-md-4 col-lg-4 text-center">
      <img src={Shape6} alt="" className="ourchefshape6" style={{transform: "rotate(180deg)"}}/>
      
    </div>
   
    <div className="col-md-4 col-lg-4 text-end">
    <img src={Shape3}   alt="" className="ourchefshape3" style={{transform: "scaleX(-1)"}}/>
  </div>
  </div>
</div>
{/* <!-- Big Burger --> */}
